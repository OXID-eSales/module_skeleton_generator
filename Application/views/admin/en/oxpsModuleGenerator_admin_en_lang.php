...
$aLang = array(
    ...
    'OXPS_MODULEGENERATOR_JS_NOTIFICATION_EXISTING_CLASSES'     => 'EXTENDED CLASSES:<hr>',
    'OXPS_MODULEGENERATOR_JS_NOTIFICATION_EXISTING_CONTROLLERS' => 'CONTROLLERS:<hr>',
    'OXPS_MODULEGENERATOR_JS_NOTIFICATION_EXISTING_MODELS'      => 'MODELS:<hr>',
    'OXPS_MODULEGENERATOR_JS_NOTIFICATION_EXISTING_LISTS'       => 'LISTS:<hr>',
    'OXPS_MODULEGENERATOR_JS_NOTIFICATION_EXISTING_WIDGETS'     => 'WIDGETS:<hr>',
    'OXPS_MODULEGENERATOR_JS_NOTIFICATION_EXISTING_BLOCKS'      => 'BLOCKS:<hr>',
    'OXPS_MODULEGENERATOR_JS_NOTIFICATION_EXISTING_SETTINGS'    => 'SETTINGS:<hr>',
);
