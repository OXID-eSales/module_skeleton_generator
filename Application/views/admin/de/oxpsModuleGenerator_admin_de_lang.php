...
$aLang = array(
    ...
    'OXPS_MODULEGENERATOR_JS_NOTIFICATION_EXISTING_CLASSES'     => '[TR - EXTENDED CLASSES:<hr>]',
    'OXPS_MODULEGENERATOR_JS_NOTIFICATION_EXISTING_CONTROLLERS' => '[TR - CONTROLLERS:<hr>]',
    'OXPS_MODULEGENERATOR_JS_NOTIFICATION_EXISTING_MODELS'      => '[TR - MODELS:<hr>]',
    'OXPS_MODULEGENERATOR_JS_NOTIFICATION_EXISTING_LISTS'       => '[TR - LISTS:<hr>]',
    'OXPS_MODULEGENERATOR_JS_NOTIFICATION_EXISTING_WIDGETS'     => '[TR - WIDGETS:<hr>]',
    'OXPS_MODULEGENERATOR_JS_NOTIFICATION_EXISTING_BLOCKS'      => '[TR - BLOCKS:<hr>]',
    'OXPS_MODULEGENERATOR_JS_NOTIFICATION_EXISTING_SETTINGS'    => '[TR - SETTINGS:<hr>]',
);
